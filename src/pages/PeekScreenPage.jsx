...
// Hero priority without timestamps exposed to frontend
          ...
          {hero === 'note' && hasNote && (
            <>
              <div className="peek-block hero">
                <div className="peek-note-text peek-hero-large">{noteBody}</div>
              </div>
            ...
            <>
              ...
              {hasNote && (
                <div className="peek-block top-left">
                  <div className="peek-note-text">{noteBody}</div>
                </div>
              )}
