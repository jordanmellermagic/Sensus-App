...
// Parse birthday primarily as ISO YYYY-MM-DD, with fallbacks.
function parseBirthday(raw) {
  ...
  // Month-name formats: "Mar 6 2008", "March 6 2008", with optional comma
  ...
  if (parts.length === 3) {
    ...
    if (idx === -1) idx = monthNamesLong.indexOf(mLower);
    if (idx !== -1) {
      month = idx + 1;
    }
  ...
  // Dash numeric non-ISO: "03-06-2008" etc.
...
export default function SpectatorDataPage() {
  ...
  const starSign =
    parsed.month && parsed.day ? getStarSign(parsed.month, parsed.day) : null;
  const daysAlive =
